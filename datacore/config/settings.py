...
class Config:
    ...
    # LLM Settings
    LLM_BASE_URL = os.getenv("LLM_BASE_URL", "http://10.0.0.150:8001/v1")
    LLM_PROVIDER = os.getenv("LLM_PROVIDER", "openai") # New: Default LLM Provider
    ...
    def LLM_API_KEY(self):
        ...
        return self.API_KEYS.get(self.LLM_PROVIDER.lower(), "not-needed")

    @property
    def LLM_BASE_URL(self):
        """Returns the base URL for the currently selected LLM_PROVIDER."""
        return self.BASE_URLS.get(self.LLM_PROVIDER.lower(), "http://10.0.0.150:8001/v1") # Default to local if not found
